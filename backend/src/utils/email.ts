...
const generateVerifyEmailTemplate = (data: Record<string, any>) => {
  const html = `
    <!DOCTYPE html>
    <html>
    <head>
...
const generatePasswordResetTemplate = (data: Record<string, any>) => {
  const html = `
    <!DOCTYPE html>
    <html>
    <head>
...
const generateWelcomeTemplate = (data: Record<string, any>) => {
  const html = `
    <!DOCTYPE html>
    <html>
    <head>
